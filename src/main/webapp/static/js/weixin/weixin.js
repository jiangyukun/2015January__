!function (window, b) {
    ...
    function n(b) {
        u && (window.WeixinJSBridge ? b() : r.addEventListener && r.addEventListener("WeixinJSBridgeReady", b, !1))
    }

    function o() {
        D.invoke || (D.invoke = function (b, c, d) {
            window.WeixinJSBridge && WeixinJSBridge.invoke(b, e(c), d)
        }, D.on = function (b, c) {
    ...
    if (!window.jWeixin)return p = {
        ...
        for (b in p)a[p[b]] = b;
        return a
    }(), r = window.document, s = r.title, t = navigator.userAgent.toLowerCase(), u = -1 != t.indexOf("micromessenger"), v = -1 != t.indexOf("android"), w = -1 != t.indexOf("iphone") || -1 != t.indexOf("ipad"), x = function () {
